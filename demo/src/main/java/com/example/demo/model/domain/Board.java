...
public class Board {
    ...
    public Board(String title, String content, String user,String newdate,String likec,String count,Long id){
        this.title = title;
    ...
    public void update(String title, String content, String user,String newdate,String likec,String count,Long id) { // 현재 객체 상태 업데이트
        this.title = title;
        this.content = content;
        this.count = count;
        this.id = id;
